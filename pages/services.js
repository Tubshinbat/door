...
const Services = ({ news, info }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Засвар үйлчилгээ - Метал хаалга - METAL DOOR`}</title>
        <meta
          name="description"
      ...
      <Header />
      <PageHead title={`Засвар үйлчилгээ`} />
      <section>
              ...
              <div className={sideCss.Side}>
                ...
                >
                  ...
                  <ul className={sideCss.Side__menus}>
                    ...
                    <li>
                      <a href={`${base.baseUrl}contact`}> Засвар үйлчилгээ </a>
                    </li>
                  </ul>
                </div>
                <div
